...
if result.id_ then 
local abbs = DevAbs:get("RoXSoURcE:User"..result.id_)
if not result.username_ then 
if abbs then 
Ali_RoX(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بسرعه، 😹💔 \nهذا معرفه @"..abbs.."", 1, 'html')
DevAbs:del("RoXSoURcE:User"..result.id_) 
end
end
...
Ali_RoX(msg.chat_id_, msg.id_, 1, abs_text[abbss], 1, 'html')
end  
DevAbs:set("RoXSoURcE:User"..result.id_, result.username_) 
end
end
end,nil) 
end
