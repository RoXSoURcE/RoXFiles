...
if DevAbs:get(RoX.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(RoX.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(RoX.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(RoX.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(RoX.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(RoX.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
RoXName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if RoXName then 
RoXNames = DevAbs:smembers(RoX.."Abs:Mute:Names"..msg.chat_id_) or ""
if RoXNames and RoXNames[1] then 
for i=1,#RoXNames do 
if RoXName:match("(.*)("..RoXNames[i]..")(.*)") then 
...
DevAbs:set(RoX.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(RoX.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
