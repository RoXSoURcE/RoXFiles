...
if DevAbs:get(RoX.."Abs:TagAdmins:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Ali_RoX(msg.chat_id_, msg.id_, 1, '⌁︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevAbs:setex(RoX..'Abs:TagAdmins:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
